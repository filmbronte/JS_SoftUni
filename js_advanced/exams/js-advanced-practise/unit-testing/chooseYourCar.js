...
console.log(chooseYourCar.carFuelConsumption(10, 190));
console.log(chooseYourCar.carFuelConsumption(5, 50));
console.log(chooseYourCar.carFuelConsumption(1, 1));
console.log(chooseYourCar.carFuelConsumption(0.15, 0.15));
console.log(chooseYourCar.carFuelConsumption(0.1888888888, 0.158888888888));
console.log(chooseYourCar.carFuelConsumption(0.1, 0.1));
console.log(chooseYourCar.carFuelConsumption(5, 0.1));
console.log(chooseYourCar.carFuelConsumption(5, 0.35));
